...
- [x] Wave 1 SUT shortlist chosen (Grok Build, OMP, Cursor Grok, Hermes Agent, Prime Agent) — see [`waves/wave-1-grok-native.md`](waves/wave-1-grok-native.md)
...
1. Finish evaluator-machine installs: `grok`, `omp`, Cursor Grok routing, `hermes`, Prime Agent try-path
