...
- **SUTs:** Grok Build (`grok`), Pi (`pi`, OMP upstream/control), OMP / Oh My Pi (`omp`), Cursor Grok (IDE agent), Hermes Agent (`hermes`), Prime Agent (`prime-agent`, try)
- **Optional next (not this wave):** OpenCode, Amp
