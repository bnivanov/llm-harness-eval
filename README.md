...
- [`waves/wave-1-grok-native.md`](waves/wave-1-grok-native.md) — Wave 1: Grok models held roughly fixed; harnesses Grok Build, OMP, Cursor Grok, Prime Agent. Setup only; no scores yet.
